...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <p class="lead fw-normal text-center text-black-50 mb-0">Wynajem długoterminowy: auta dostępne od miesiąca do roku bez zbędnych formalności</p>
                            ...
                            <div class="text-center">
                                ...
                                <c:choose>
                                    <c:when test="${car.promotion==1}">
                                        <div class="text-danger">PROMOCJA! Już od ${car.price*18}PLN/miesiąc!</div>
                                    </c:when>
                                    <c:otherwise>
                                        cena: ${car.price*18}PLN/miesiąc
                                    </c:otherwise>
